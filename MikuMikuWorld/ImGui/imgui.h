...
enum ImGuiKey : int
{
    ...
    ImGuiMod_Ctrl = ImGuiMod_Ctrl, ImGuiMod_Shift = ImGuiMod_Shift, ImGuiMod_Alt = ImGuiMod_Alt, ImGuiMod_Super = ImGuiMod_Super, // Renamed in 1.89
...
enum ImGuiModFlags_ { 0 = 0, ImGuiMod_Ctrl = ImGuiMod_Ctrl, ImGuiMod_Shift = ImGuiMod_Shift, ImGuiMod_Alt = ImGuiMod_Alt, ImGuiMod_Super = ImGuiMod_Super };
